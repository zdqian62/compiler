...
public interface MicroListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link MicroParser#none}.
	 * @param ctx the parse tree
	 */
	void enterNone(MicroParser.NoneContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroParser#none}.
	 * @param ctx the parse tree
	 */
	void exitNone(MicroParser.NoneContext ctx);
	/**
